...
class CentrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create centro" do
    assert_difference('Centro.count') do
      post centros_url, params: { centro: { estados_id: @centro.estados_id, nombre: @centro.nombre } }
    end
  ...
  test "should update centro" do
    patch centro_url(@centro), params: { centro: { estados_id: @centro.estados_id, nombre: @centro.nombre } }
