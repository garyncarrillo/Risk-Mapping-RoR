...
class TipoObjetivosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tipo_objetivo" do
    assert_difference('TipoObjetivo.count') do
      post tipo_objetivos_url, params: { tipo_objetivo: { descripcion: @tipo_objetivo.descripcion, estado: @tipo_objetivo.estado } }
    end
  ...
  test "should update tipo_objetivo" do
    patch tipo_objetivo_url(@tipo_objetivo), params: { tipo_objetivo: { descripcion: @tipo_objetivo.descripcion, estado: @tipo_objetivo.estado } }
