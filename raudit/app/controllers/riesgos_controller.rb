class RiesgosController < ApplicationController
  ...
  private
    ...
    def riesgo_params
      params.require(:riesgo).permit(:idprodimientos, :descripcion, :causa, :efecto, :r_categoria, :nivel_riesgo_inherente, :f_natural, :f_humano, :f_proceso, :f_tecnologico, :f_otros)
    end
end
